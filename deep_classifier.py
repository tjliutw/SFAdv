...
def get_args():
    ...
    opt.statFile = opt.clfRootDir + '/asr_stat_dl.csv'
    ...
    opt.classifierFile = [opt.modelPath + '/VGG11_test.pth', opt.modelPath + '/ResNet18_test.pth', opt.modelPath + '/LeNet5_test.pth', opt.modelPath + '/SmallAlexNet_test.pth'] 
    opt.seed = 42  
...
#    #####<<<<>>>>
#    opt.trainContainersFile = opt.datasetDir + '/train_containers-%d.npy' % (0)
#    opt.trainFeaturesFile = opt.datasetDir + '/train_features-%d.npy' % (0)
#    opt.trainLabelsFile = opt.datasetDir + '/train_labels-%d.npy' % (0)
#    opt.testContainersFile = opt.datasetDir + '/test_containers-%d.npy' % (0)
#    opt.testFeaturesFile = opt.datasetDir + '/test_features-%d.npy' % (0)
#    opt.testLabelsFile = opt.datasetDir + '/test_labels-%d.npy' % (0)
...
class Dataset:      
    ...
    def load_data(self, ):     
        return torch.tensor(self.testX).float(), torch.tensor(self.testF).float(), torch.tensor(self.testY)
    # end of load_data()  
